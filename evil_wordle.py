...
class Keyboard:
    ...
    def __str__(self):
        ...
        for letter in row1:
            if letter != " ":
                colored_row1 += color_word(self.colors[letter], letter) + " "

        for letter in row2:
            if letter != " ":
                colored_row2 += color_word(self.colors[letter], letter) + " "
                
        for letter in row3:
            if letter != " ":
                colored_row3 += color_word(self.colors[letter], letter) + " "

        colored_row1 = colored_row1.rstrip()
        colored_row2 = colored_row2.rstrip()
        colored_row3 = colored_row3.rstrip()
        return f"{colored_row1}\n{colored_row2}\n{colored_row3}"
